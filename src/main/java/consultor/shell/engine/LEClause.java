package consultor.shell.engine;

import consultor.shell.enums.IntersectionType;

/**
 * Created by cschen on 6/6/16.
 */
public class LEClause extends Clause {
    ...
    protected IntersectionType intersect(Clause rhs) {
        ...
        if(isNumeric){
            ...
            else if(rhs instanceof LessClause)
            {
                //v1 <= a
                //v2 < b
                //matched: b <= a
